...
GHDDI数据科学部由12位来自交叉学科的科学家和工程师组成，他们是郭晋疆博士、吕小莹博士、郭涵博士、李杰博士、张媛、胡松博士、芦茜、梁忱、刘奇、李洋博士、汤卓和马路遥，其学科领域包含：计算化学、生物信息学、计算机科学和软件工程。团队管理着58台GHDDI本地高性能计算（HPC）集群以及10亿级化学、生物和制药数据。我们的使命是借助自研的数据科学平台推动药物发现的进程。通过综合利用内部的人工智能系统、工具、软件以及合作伙伴的支持，我们为药物发现流程中的实际问题提供解决方案。团队专注于不断探索技术创新，以进一步加快药物发现进程。我们正在构建基础人工智能技术以赋能研发人员做出更好的决策。
...
合作伙伴：[默克集团](https://www.merckgroup.com/en), [阿里云](https://www.alibabacloud.com/), [微软研究院](https://www.microsoft.com/en-us/research/lab/microsoft-research-ai4science/)
