...
The following is an updated list of studies publishing in vitro experimental results. The studies were complied using several well known preprint and publication databases relating to SARS-CoV-2 and COVID-19. The drug names and numerical results are found using simple NLP scripts. This list should be used as a reference only and not is 100% accurate or complete.
...
|  102  | Thiethylperazine Maleate       | 8.02  | 18.37  | 2.29  | 
...
|  139  | Etifoxine  | 20.64  | 43.53  | 2.11  | 
